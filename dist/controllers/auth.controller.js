...
exports.resetPassword = exports.forgotPassword = exports.refresh = exports.login = exports.signup = void 0;
...
exports.login = (0, error_middleware_1.asyncHandler)(async (req, res) => {
    ...
    const emailNorm = normalizeEmail(email);
    const user = await User_model_1.default.findOne({ email: { $in: (0, emailAddress_1.emailLookupCandidates)(email) }, isActive: true })
...
exports.forgotPassword = (0, error_middleware_1.asyncHandler)(async (req, res) => {
    ...
    const okResponse = (debugResetLink) => res.json({
        success: true,
    ...
    if (!emailNorm || !emailNorm.includes("@"))
        return okResponse();
    const user = await User_model_1.default.findOne({ email: { $in: (0, emailAddress_1.emailLookupCandidates)(req.body?.email) }, isActive: true })
        .collation(EMAIL_COLLATION)
    ...
    try {
        const result = await (0, email_1.sendEmail)({ to: emailNorm, subject, text });
