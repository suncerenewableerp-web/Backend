...
exports.validateResetToken = exports.validatePassword = exports.validateEmail = exports.validateTicketDeleteConfirmId = exports.validateTicketId = exports.validate = void 0;
...
exports.validateTicketDeleteConfirmId = (0, express_validator_1.body)("confirmId")
    .isString()
    .trim()
    .notEmpty()
