...
router.post('/:id/onsite/assign', (0, auth_middleware_1.authorize)('tickets', 'edit'), (0, validate_middleware_1.validate)([validate_middleware_1.validateTicketId]), (0, error_middleware_1.asyncHandler)(ticket_controller_1.assignOnsiteBooking));
router.put('/:id/onsite/jobcard', (0, auth_middleware_1.authorize)('jobcard', 'edit'), (0, validate_middleware_1.validate)([validate_middleware_1.validateTicketId]), (0, error_middleware_1.asyncHandler)(ticket_controller_1.upsertOnsiteJobCard));
...
router.get('/:id/installation-documents', (0, auth_middleware_1.authorize)('tickets', 'view'), (0, validate_middleware_1.validate)([validate_middleware_1.validateTicketId]), (0, error_middleware_1.asyncHandler)(ticket_controller_1.getTicketInstallationDocuments));
router.post('/:id/installation-documents', (0, auth_middleware_1.authorize)('tickets', 'view'), (0, validate_middleware_1.validate)([validate_middleware_1.validateTicketId]), upload_middleware_1.installationDocumentUpload.single('file'), (0, error_middleware_1.asyncHandler)(ticket_controller_1.uploadTicketInstallationDocument));
