...
router.post('/:id/pickup-details', (0, auth_middleware_1.authorize)('tickets', 'view'), (0, validate_middleware_1.validate)([validate_middleware_1.validateTicketId]), (0, error_middleware_1.asyncHandler)(ticket_controller_1.upsertTicketPickupDetails));
router.post("/:id/pickup-documents", (0, auth_middleware_1.authorize)("tickets", "view"), (0, validate_middleware_1.validate)([validate_middleware_1.validateTicketId]), upload_middleware_1.pickupDocumentUpload.single("file"), (0, error_middleware_1.asyncHandler)(ticket_controller_1.uploadTicketPickupDocument));
